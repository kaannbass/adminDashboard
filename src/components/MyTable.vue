        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="https://media.licdn.com/dms/image/C4D03AQFQhEXmca8rSA/profile-displayphoto-shrink_800_800/0/1605862956409?e=2147483647&v=beta&t=v-Z-TfeM_U8dIELYiwhXOzRcXIU1ZmU-MlINpbi1zcU"
 alt="Kaan Baş">
                    <div class="pl-3">
            ...
            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="@/assets/logo.png" alt="Jese image">
                    <div class="pl-3">
                        <div class="text-base font-semibold">Vue.js</div>
                        <div class="font-normal text-gray-500">vue@vue.com</div>
                    </div>
                </th>
                <td class="px-6 py-4">
                    VUE
